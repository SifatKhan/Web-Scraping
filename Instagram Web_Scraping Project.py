...
class App:
    def __init__(self, username='username', password='password', target_username='target_username',
                 path='InstaPhotos'): #Change this to your Instagram details and desired images path
    ...
    def close_dialog_box(self):
        try:
            sleep(5)
            close_btn = self.driver.find_element_by_xpath('/html/body/div[4]/div/div/div[3]/button[2]')
            sleep(3)
    ...
    def log_in(self, ):
        try:
            log_in_button = self.driver.find_element_by_xpath('//*[@id="react-root"]/section/main/article/div[2]/div[1]/div/form/div[4]')
            log_in_button.click()
            sleep(3)
        except Exception:
            self.error = True
